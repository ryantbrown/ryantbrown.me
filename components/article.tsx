  ...
  return (
    <article className="md:grid md:grid-cols-4 md:items-baseline">
      <div className="group relative flex flex-col items-start md:col-span-3">
        <h2 className="font-semibold text-base text-gray-800 tracking-tight dark:text-gray-100">
        ...
        <p className="relative z-10 mt-2 text-gray-600 text-sm dark:text-gray-400">
          {article.description}
        </p>
        <div
          aria-hidden="true"
