...
import { ContentContainer, MainContainer } from "./container";
...
export function PageLayout({
  ...
  return (
    <MainContainer>
      <ContentContainer className="mt-14 md:mt-20">
        <div className="max-w-2xl">
          <h1 className="text-balance font-bold text-4xl text-gray-800 leading-10 tracking-tight sm:text-5xl dark:text-gray-100">
            {title}
          </h1>
          {description && (
